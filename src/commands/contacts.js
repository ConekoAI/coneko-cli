 ...
 * @param {string} query - Username or fingerprint to search
 ...
 * @param {string} address - Username@domain
 * @param {Object} options - Options
 */
...
async function remove(address, options) {
  ...
  try {
    ...
    // This endpoint doesn't exist yet in server, but structure is ready
