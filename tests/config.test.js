...
describe('Config Module', () => {
  ...
  describe('loadKeys', () => {
    test('returns keys when file exists', async () => {
      ...
      fs.readJson.mockResolvedValue(mockKeys);
  ...
  describe('loadConfig', () => {
    test('returns config when file exists', async () => {
      const mockConfig = { relay: 'https://custom.relay.com' };
      fs.pathExists.mockResolvedValue(true);
    ...
    test('returns default config when file does not exist', async () => {
      ...
      expect(config).toEqual({ relay: 'https://api.coneko.ai' });
    });
  });

  describe('saveConfig', () => {
    test('writes config to file', async () => {
      const config = { relay: 'https://test.relay.com' };
